    ...
    return (
      <div className="confirm__disclosure">
        <div className="confirm">
          ...
          <p>BloqBoard is a free software-based tool intended to help users to create and display their loan requests for ERC20-compatible blockchain tokens issued in compliance with the Dharma Protocol on a purely peer-to-peer basis. BloqBoard is not a regulated marketplace, exchange or intermediary of any kind and is merely an aggregator of information.</p>
